# experimental-household-ranking-list

## Endpoint
- Method: `post`
- Path: `/api/v1/{tenant_id}/experimental-households-ranking/list`
...
- fields:
  ...
  - requestBody (application/json).filter
    - type: string
    - required: no
    - description: The Expression to filter the household rankings by. See the Readme for more details on the Expression format.
  - requestBody (application/json).pagination_params
    - type: object
    - required: no
    - description: The pagination information for the household rankings
  ...
  - requestBody (application/json).sort_keys
    - type: ['array', 'null']
    - required: no
    - description: The keys to sort the household rankings by
  - requestBody (application/json).sort_keys[]
    - type: object
    - required: no
    - description: The keys to sort the household rankings by
...
- 200
  - description: OK
  - content-type: application/json
  - schema: VPOCHouseholdRankingListOutputBody
