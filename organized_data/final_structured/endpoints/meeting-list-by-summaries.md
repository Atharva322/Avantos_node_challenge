# meeting-list-by-summaries

## Endpoint
- Method: `post`
- Path: `/api/v1/{tenant_id}/meetings/summaries`
...
- is_attested
  - type: boolean
  - required: no
  - description: Whether the meeting has an attested summary
...
- 200
  - description: OK
  - content-type: application/json
  - schema: MeetingListBySummariesOutputBody
