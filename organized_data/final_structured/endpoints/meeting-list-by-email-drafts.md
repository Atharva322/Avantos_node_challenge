# meeting-list-by-email-drafts

## Endpoint
- Method: `post`
- Path: `/api/v1/{tenant_id}/meetings/email-drafts`
...
- start_time_after
  - type: string
  - required: no
  - description: Optional filter for meetings starting after this time (RFC3339 format)
- start_time_before
  - type: string
  - required: no
  - description: Optional filter for meetings starting before this time (RFC3339 format)
- sent_flag
  - type: boolean
  - required: no
  - description: Whether the email draft has been sent
...
- fields:
  ...
  - requestBody (application/json).filter
    - type: string
    - required: no
    - description: The Expression to filter the meetings by
  - requestBody (application/json).pagination_params
    - type: object
    - required: no
    - description: The pagination information for the meetings
  ...
  - requestBody (application/json).sort_keys
    - type: ['array', 'null']
    - required: no
    - description: The keys to sort the meetings by
  - requestBody (application/json).sort_keys[]
    - type: object
    - required: no
    - description: The keys to sort the meetings by
...
- 200
  - description: OK
  - content-type: application/json
  - schema: MeetingListByEmailDraftsOutputBody
